    ...
    <Layout>
      <div className="container" style={{ paddingTop: '60px', paddingBottom: '60px' }}>
        ...
        <p style={{ marginTop: 24, marginBottom: 24, textAlign: 'justify' }}>
          At the Institute for Digital Technology and Economy – HUST, student life goes beyond the
          classroom. We offer a wide range of academic, professional, and creative activities to
          help students apply their knowledge, gain real-world experience, and connect with leaders
