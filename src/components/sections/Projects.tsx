...
export default function Projects() {
  return (
    <>
      <section className="project__area-two" id="projects">
          ...
          <div className="row gutter-24">
            <div className="col-lg-8">
              <div className="project__item-two">
                ...
                <div className="project__content-two">
                  <h2 className="title">
                    <Link href="/project-details">VChain</Link>
                  </h2>
                  <span>
            ...
            {/* <div className="col-lg-4 col-md-6">
              <div className="project__item-two">
                ...
                <div className="project__content-two">
                  <h2 className="title">
                    <Link href="/project-details">Digital Agency</Link>
                  </h2>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="project__item-two">
                ...
                <div className="project__content-two">
                  <h2 className="title">
                    <Link href="/project-details">B4E</Link>
                  </h2>
                  <span>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="project__item-two">
                ...
                <div className="project__content-two">
                  <h2 className="title">
                    <Link href="/project-details">BAgri</Link>
                  </h2>
                  <span>
            ...
            <div className="col-lg-8">
              <div className="project__item-two">
                ...
                <div className="project__content-two">
                  <h2 className="title">
                    <Link href="/project-details">BSign</Link>
                  </h2>
                  <span>
