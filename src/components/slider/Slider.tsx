            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="slider__content">
                  <span className="sub-title">BKFintech</span>
                  <h2 className="title">BKFintech</h2>
                  <p>
                    Agilos helps you to convert your data into a strategic asset and get business
                    insights Agilos helps you to convert.
                  </p>
